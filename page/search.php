...
$posts = $conn->prepare("SELECT * FROM post WHERE title LIKE '%$target%' ORDER BY date DESC");
$posts->execute();
...
<body>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="pages.php">مقالات</a>
                    </li>
                ...
                <form method="post" class="form-inline my-2 my-lg-0 margin-right" style="margin-right:auto;">
                    <input class="form-control mr-sm-2 placholder" type="search" placeholder="دنبال چی میگردی؟" aria-label="Search" value="<?= $target ?>" name="searchcontent">
        ...
        <div>
            ...
            نتایج مرتبط برای جستجوی"<?= $target ?>"        
            </h3>
            <div class="row">
